...
# Logger is now set to log into "lightning_logs/baseline" with the name "baseline"
logger = TensorBoardLogger("lightning_logs/baseline", name="baseline")
...
tft = TemporalFusionTransformer.from_dataset(
    ...
    output_size=7,            # default output size for quantile predictions
